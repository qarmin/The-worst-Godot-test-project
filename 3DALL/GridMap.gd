...
func _process(delta) -> void:
	...
	if counter <= 0:
		...
		if randi() % 2 == 1:
			Autoload.qq = str(get_bake_mesh_instance(Autoload.get_int()))
		if randi() % 2 == 1:
			Autoload.qq = str(get_bake_meshes())
		if randi() % 2 == 1:
			Autoload.qq = str(get_cell_item(Autoload.get_int(),Autoload.get_int(),Autoload.get_int()))
		if randi() % 2 == 1:
			Autoload.qq = str(get_cell_item_orientation(Autoload.get_int(),Autoload.get_int(),Autoload.get_int()))
		if randi() % 2 == 1:
		...
		if randi() % 2 == 1:
			Autoload.qq = str(get_used_cells())

		if randi() % 2 == 1:
			make_baked_meshes(Autoload.get_bool(), Autoload.get_float())
		if randi() % 2 == 1:
			Autoload.qq = str(map_to_world(Autoload.get_int(),Autoload.get_int(),Autoload.get_int()))
		...
		if randi() % 2 == 1:
			Autoload.qq = str(world_to_map(Autoload.get_vector3()))
