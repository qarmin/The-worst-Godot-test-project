...
func nodeFunction(q_KinematicBody3D: KinematicBody3D, can_reset: bool = false) -> void:
	...
	if Autoload.SLOW_FUNCTIONS:
		...
		q_KinematicBody3D.move_and_slide_with_snap(
			Autoload.get_vector3(), Autoload.get_vector3(), Autoload.get_vector3(), Autoload.get_bool(), Autoload.get_int(), Autoload.get_float(), Autoload.get_bool()
		)
