...
#		q_EditorSpatialGizmo.add_handles( Autoload.get_packedvector3array(), StandardMaterial3D.new(), Autoload.get_bool(), Autoload.get_bool())
#		q_EditorSpatialGizmo.add_lines( Autoload.get_packedvector3array(), StandardMaterial3D.new(), Autoload.get_bool())
#		q_EditorSpatialGizmo.add_mesh( temp_ArrayMesh, Autoload.get_bool(), RID(), StandardMaterial3D.new())
