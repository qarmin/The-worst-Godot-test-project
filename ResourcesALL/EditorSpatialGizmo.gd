...
#		q_EditorSpatialGizmo.add_handles( Autoload.get_poolvector3array(), SpatialMaterial.new(), Autoload.get_bool(), Autoload.get_bool())
#		q_EditorSpatialGizmo.add_lines( Autoload.get_poolvector3array(), SpatialMaterial.new(), Autoload.get_bool())
