...
#		q_EditorSpatialGizmo.add_handles( PoolVector3Array([Vector3(randf() * 50,randf() * 50,randf() * 50),Vector3(randf() * 50,randf() * 50,randf() * 50)]), Material.new(), Autoload.get_bool(), Autoload.get_bool())
#		q_EditorSpatialGizmo.add_lines( PoolVector3Array([Vector3(randf() * 50,randf() * 50,randf() * 50),Vector3(randf() * 50,randf() * 50,randf() * 50)]), Material.new(), Autoload.get_bool() )
