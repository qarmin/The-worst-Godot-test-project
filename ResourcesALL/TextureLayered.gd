...
#
#		q_TextureLayered.get_depth())
#		q_TextureLayered.get_format())
#		q_TextureLayered.get_height())
#		q_TextureLayered.get_layer_data( Autoload.get_int()))
#		q_TextureLayered.get_width())
#
