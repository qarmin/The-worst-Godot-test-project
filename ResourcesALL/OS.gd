...
#		qq += str(q_OS.get_datetime_from_unix_time(Autoload.get_int()))
...
#		qq += str(q_OS.get_screen_dpi(Autoload.get_int()))
...
#		qq += str(q_OS.get_system_dir(Autoload.get_int())) # SystemDir
...
#		qq += str(q_OS.get_video_driver_name(Autoload.get_int())) # VideoDriver
