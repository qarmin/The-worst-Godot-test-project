...
func alt_process(delta) -> void:
	...
	if counter <= 0:
		...
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.autotile_get_bitmask( Autoload.get_int(), Autoload.get_vector2() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.autotile_get_bitmask_mode( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.autotile_get_icon_coordinate( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.autotile_get_light_occluder( Autoload.get_int(), Autoload.get_vector2() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.autotile_get_navigation_polygon( Autoload.get_int(), Autoload.get_vector2() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.autotile_get_size( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.autotile_get_spacing( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.autotile_get_subtile_priority( Autoload.get_int(), Autoload.get_vector2() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.autotile_get_z_index( Autoload.get_int(), Autoload.get_vector2() ))
		if randi() % 2 == 1:
		...
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.find_tile_by_name( Autoload.get_string() ))

		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.get_last_unused_tile_id())
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.get_tiles_ids())
		...
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_light_occluder( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_material( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_modulate( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_name( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_navigation_polygon( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_navigation_polygon_offset( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_normal_map( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_occluder_offset( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_region( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_shape( Autoload.get_int(), Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_shape_count( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_shape_offset( Autoload.get_int(), Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_shape_one_way( Autoload.get_int(), Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_shape_one_way_margin( Autoload.get_int(), Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_shape_transform( Autoload.get_int(), Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_shapes( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_texture( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_texture_offset( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_tile_mode( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_TileSet.tile_get_z_index( Autoload.get_int() ))
		if randi() % 2 == 1:
