...
func alt_process(delta) -> void:
	...
	if counter <= 0:
		...
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.get_end_node())
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.get_graph_offset())
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.get_node( Autoload.get_string() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.get_node_name( AnimationNode.new()))
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.get_node_position( Autoload.get_string() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.get_start_node())
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.get_transition( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.get_transition_count())
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.get_transition_from( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.get_transition_to( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.has_node( Autoload.get_string() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_AnimationNodeStateMachine.has_transition( Autoload.get_string(), Autoload.get_string() ))
		if randi() % 2 == 1:
