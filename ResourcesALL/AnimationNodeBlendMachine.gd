...
func _process(delta) -> void:
	...
	if counter <= 0:
		...
		if randi() % 2 == 1:
			qq += str(q_AnimationNodeStateMachine.get_transition( Autoload.get_int() ))
		if randi() % 2 == 1:
			qq += str(q_AnimationNodeStateMachine.get_transition_count())
		if randi() % 2 == 1:
			qq += str(q_AnimationNodeStateMachine.get_transition_from( Autoload.get_int() ))
		if randi() % 2 == 1:
			qq += str(q_AnimationNodeStateMachine.get_transition_to( Autoload.get_int() ))
		if randi() % 2 == 1:
