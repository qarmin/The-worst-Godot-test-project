...
func _process(delta) -> void:
	...
	if counter <= 0:
		...
		if !Autoload.RANDI:
			...
			q_ParticlesMaterial.set_trail_color_modifier(Autoload.loadA("res://RES/Gradient1.tres",false))
			...
			q_ParticlesMaterial.set_emission_point_texture(Autoload.loadA("res://RES/Sprite" + str(randi()%4 + 1) + ".png",false))
			q_ParticlesMaterial.set_emission_normal_texture(Autoload.loadA("res://RES/Sprite" + str(randi()%4 + 1) + ".png",false))
			q_ParticlesMaterial.set_emission_color_texture(Autoload.loadA("res://RES/Sprite" + str(randi()%4 + 1) + ".png",false))
			...
			q_ParticlesMaterial.set_color_ramp(Autoload.loadA("res://RES/Sprite" + str(randi()%4 + 1) + ".png",false))
			...
			for j in range(12): # range(12):
				...
				q_ParticlesMaterial.set_param_texture(j,Autoload.loadA("res://RES/Sprite" + str(randi()%4 + 1) + ".png",false))
