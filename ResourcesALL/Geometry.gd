...
#		qq += str(Geometry.build_capsule_planes(Autoload.get_float(),Autoload.get_float(),Autoload.get_int(),Autoload.get_int(),Autoload.get_int())) # AXIS 
#		qq += str(Geometry.build_cylinder_planes(Autoload.get_float(),Autoload.get_float(),Autoload.get_int(),Autoload.get_int())) # AXIS 
#
...
#
#		qq += str(Geometry.offset_polygon_2d(Autoload.get_poolvector2array(), Autoload.get_float(), Autoload.get_int())) # PolyJointType
#		qq += str(Geometry.offset_polyline_2d(Autoload.get_poolvector2array(), Autoload.get_float(), Autoload.get_int(), Autoload.get_int())) # PolyJointType, PoolEndtype
#
...
#		qq += str(Geometry.segment_intersects_convex(Autoload.get_vector3(),Autoload.get_vector3(),Autoload.get_array()))
