...
var q_PackedInt64Array: PackedInt32Array = Autoload.get_packedint32array()
...
func nodeFunction(q_PackedInt64Array: PackedInt32Array, can_reset: bool = false) -> void:
	if can_reset:
		if randi() % 2 == 1:
			q_PackedInt64Array = Autoload.get_packedint32array()

	if randi() % 2 == 1:
		q_PackedInt64Array.append(Autoload.get_int())
	if randi() % 2 == 1:
		q_PackedInt64Array.append_array(Autoload.get_packedint32array())
