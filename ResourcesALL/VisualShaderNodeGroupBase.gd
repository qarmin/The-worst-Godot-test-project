...
#				for i in range(5):
#					q_VisualShaderNodeGroupBase.add_input_port( i, randi() % Autoload.RANGE - Autoload.RANGE / 2, "Dżony" )
#					q_VisualShaderNodeGroupBase.add_output_port( i, randi() % Autoload.RANGE - Autoload.RANGE / 2, "Ring" )
#
#				#MOVED q_VisualShaderNodeGroupBase.clear_input_ports()
#				#MOVED q_VisualShaderNodeGroupBase.clear_output_ports()
#
