...
#	BUG	if randi() % 2 == 1:
#			Autoload.qq = str(q_VisualShaderNodeGroupBase.get_control( Autoload.get_int() ))
		if randi() % 2 == 1:
			Autoload.qq = str(q_VisualShaderNodeGroupBase.get_free_input_port_id())
		if randi() % 2 == 1:
			Autoload.qq = str(q_VisualShaderNodeGroupBase.get_free_output_port_id())
		if randi() % 2 == 1:
			Autoload.qq = str(q_VisualShaderNodeGroupBase.get_input_port_count())
		if randi() % 2 == 1:
			Autoload.qq = str(q_VisualShaderNodeGroupBase.get_inputs())
		if randi() % 2 == 1:
			Autoload.qq = str(q_VisualShaderNodeGroupBase.get_output_port_count())
		if randi() % 2 == 1:
			Autoload.qq = str(q_VisualShaderNodeGroupBase.get_outputs())
		if randi() % 2 == 1:
			Autoload.qq = str(q_VisualShaderNodeGroupBase.get_size())

		if randi() % 2 == 1:
			Autoload.qq = str(q_VisualShaderNodeGroupBase.has_input_port(Autoload.get_int()))
		if randi() % 2 == 1:
			Autoload.qq = str(q_VisualShaderNodeGroupBase.has_output_port(Autoload.get_int()))
