...
#		qq += str(q_ClassDB.class_get_integer_constant_list(Autoload.get_string(),Autoload.get_bool()))
#		qq += str(q_ClassDB.class_get_method_list(Autoload.get_string(), Autoload.get_bool()))
#		qq += str(q_ClassDB.class_get_property(self,Autoload.get_string()))
#		qq += str(q_ClassDB.class_get_property_list(Autoload.get_string(), Autoload.get_bool()))
#		qq += str(q_ClassDB.class_get_signal(Autoload.get_string(), Autoload.get_string()))
#		#qq += str(q_ClassDB.class_get_signal_list(Autoload.get_string(), Autoload.get_bool()))
#		qq += str(q_ClassDB.class_has_integer_constant(Autoload.get_string(),Autoload.get_string()))
#		qq += str(q_ClassDB.class_has_method(Autoload.get_string(),Autoload.get_string(), Autoload.get_bool()))
