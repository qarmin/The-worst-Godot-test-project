...
func _process(delta) -> void:
	...
	if counter <= 0:
		...
		### Autoload.qq = str(_clips_input())
		### Autoload.qq = str(_get_minimum_size())
		### _gui_input(Autoload.loadA("InputEventAction.tres"))
		### Autoload.qq = str(_make_custom_tooltip("Aha"))
		if randi() % 2 == 1:
			accept_event()
		if randi() % 2 == 1:
		...
		### Autoload.qq = str(can_drop_data(Autoload.get_vector2(), "Hehe"))
		### drop_data(Autoload.get_vector2()
		if randi() % 2 == 1:
			force_drag(Autoload.get_string(), self)
		if randi() % 2 == 1:
			Autoload.qq = str(get_begin())
		if randi() % 2 == 1:
			Autoload.qq = str(get_color(Autoload.get_string(), Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(get_combined_minimum_size())
		if randi() % 2 == 1:
			Autoload.qq = str(get_constant(Autoload.get_string(), Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(get_cursor_shape(Autoload.get_vector2() ))
		### Autoload.qq = str(get_drag_data(Autoload.get_vector2()))
		if randi() % 2 == 1:
			Autoload.qq = str(get_end())
		if randi() % 2 == 1:
			Autoload.qq = str(get_focus_owner())
		if randi() % 2 == 1:
			Autoload.qq = str(get_font(Autoload.get_string(), Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(get_global_rect())
		if randi() % 2 == 1:
			Autoload.qq = str(get_icon(Autoload.get_string(), Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(get_minimum_size())
		if randi() % 2 == 1:
			Autoload.qq = str(get_parent_area_size())
		if randi() % 2 == 1:
			Autoload.qq = str(get_parent_control())
		if randi() % 2 == 1:
			Autoload.qq = str(get_rect())
		if randi() % 2 == 1:
			Autoload.qq = str(get_rotation())
		if randi() % 2 == 1:
			Autoload.qq = str(get_stylebox(Autoload.get_string(), Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(get_tooltip(Autoload.get_vector2()))
		if randi() % 2 == 1:
			grab_click_focus()
		if randi() % 2 == 1:
			grab_focus()
		if randi() % 2 == 1:
			Autoload.qq = str(has_color(Autoload.get_string(), Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(has_color_override(Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(has_constant(Autoload.get_string(), Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(has_constant_override(Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(has_focus())
		if randi() % 2 == 1:
			Autoload.qq = str(has_font_override(Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(has_icon(Autoload.get_string(), Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(has_icon_override(Autoload.get_string()))
		### Autoload.qq = str(has_point(Autoload.get_vector2()))
		if randi() % 2 == 1:
			Autoload.qq = str(has_shader_override(Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(has_stylebox(Autoload.get_string(), Autoload.get_string()))
		if randi() % 2 == 1:
			Autoload.qq = str(has_stylebox_override(Autoload.get_string()))
		if randi() % 2 == 1:
